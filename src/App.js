...
const ethAmount = '0.006 / 0.009'
const image = 'https://media.discordapp.net/attachments/1084925458711326840/1100924929546915950/BASE_54x.png?width=586&height=586'
const Title = 'Dog Eat Dog'
const supply = 1805
